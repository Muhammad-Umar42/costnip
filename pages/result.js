    ...
    return (
        <>
            ...
            <div className="bg-[#3063E0] py-20 mb-20">
                <div className="countain grid grid-cols-1 md:grid-cols-2">
                    <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 countain">
                ...
                {/* ////////////////sideBar/////////////// */}
                <div className=''>
                    <Image className='pb-4 w-full md:w-10/12' src="/upload.png" alt="image" width={220} height={100} />
                    <Image className='pb-4 w-full md:w-10/12' src="/location2.png" alt="image" width={220} height={100} />
                    <Image className='pb-4 w-full md:w-10/12' src="/doctor.png" alt="image" width={220} height={100} />
                </div>
                ...
                <div className='col-span-3'>
                    <div>
                        ...
                        <h1 className='text-gray-400 font-semibold'> <span className='text-gray-800'>Results</span> - knee replacement (3) </h1>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-6">
                            {/* //////////CarD-Start//////// */}
                            <div className='grid grid-cols-2 border-gray-200 border-solid border rounded-md'>
                                <div className='m-[auto] pl-4'>
                                    <img className='w-12 pb-2' src="hospital.png" alt="" />
                                    <h1 className='text-xs pb-2 font-bold'>LOCATION <span className='rounded-full bg-[#43AA8B] text-white text-center p-[2px] text-[8px] font-semibold'> 3 miles away </span></h1>
                                    <h3 className='text-xs '>Genral Hospital</h3>
                                    <h3 className='text-xs  text-gray-400'>123 Main st. Chicago, IL 20202</h3>
                                </div>
                                <div className='m-[auto]'>
                                    <h1 className='font-semibold'><span className='text-gray-600 text-xs'>$</span>64.82 &#8605;</h1>
                                    <h1 className='text-gray-400 text-[8px] mb-2'>Hospital Reported Cash Price</h1>
                                    {/* /////////// */}
                                    <h1 className='font-semibold'><span className='text-gray-600 text-xs'>$</span>40</h1>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 bg-[#CDDCFF] py-12 px-8 my-12 rounded-lg">
                            <div className='col-span-2'>
                                <h3 className='text-gray-500 text-xl mb-6'>Lipsum subtitle</h3>
                                <h1 className='text-gray-800 font-semibold text-5xl mb-6 max-w-[500px]'>Placeholder title goes here for visuals</h1>
                                <h3 className='text-gray-500 text-xl mb-6'>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum'. <span className='text-blue-500 underline'> Learn more </span></h3>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-3 md:grid-cols-6 p-8 my-4 shadow-xl rounded-lg">
                            <div className='m-[auto]'>
                            ...
                            <div className='col-span-2'>
                                ...
                                <h2 className='font-semibold text-2xl text-center'>Atlanta Hospital</h2>
                                <h3 className='txt-gray-300 text-center'>123 Main st. Chicago, IL 20202</h3>
                            </div>
